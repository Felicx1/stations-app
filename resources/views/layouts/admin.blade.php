    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-slate-100 md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <a href="#" class="text-lg font-semibold tracking-widest text-blue-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">ReelAnalytics</a>
                ...
                <x-admin-nav-link :href="route('admin.stations.index')" :active="request()->routeIs('admin.stations.index')">
                        {{ __('Stations Status') }}
                </x-admin-nav-link>
